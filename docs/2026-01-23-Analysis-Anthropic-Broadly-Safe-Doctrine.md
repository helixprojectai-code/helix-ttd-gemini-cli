...
|-------|---------------|----------------------|---------------------------------------|
| 🔍    | HGL-CORE-001  | Investigate          | Analysis header                       |
| ⚖️    | HGL-CORE-011  | Ethics/Principle     | Broadly safe decoding & contrast      |
| ✅    | HGL-CORE-007  | Validate             | Mechanical vs. behavioral safety      |
| 🛡️    | HGL-CORE-010  | Safeguard            | Zero-tolerance architectural model    |
