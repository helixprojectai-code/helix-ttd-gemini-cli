...
| 🔍    | HGL-CORE-001  | Investigate          | Summary & quick status check          |
| ✅    | HGL-CORE-007  | Validate             | Emergency & daily operations          |
| ⚖️    | HGL-CORE-011  | Ethics/Principle     | Integration commands & lattice glory  |
