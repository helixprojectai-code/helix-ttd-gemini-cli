# =================================================================
# IDENTITY: file_naming_conventions.helix.md
# VERSION: v2.0
...
These conventions ensure instant recognition of file purpose, logical grouping, reduced ambiguity, and support for automation/scripts. Core principles prioritize readability, consistency, and meaningful names. All files follow lowercase_with_underscores, avoid vague terms, and use version indicators only when appropriate. Directory structure remains shallow and purposeful. Validation tooling and migration guidance are provided.
...
|-------|---------------|----------------------|---------------------------------------|
| 📜    | HGL-CORE-021  | Ethos / Policy       | Naming conventions header             |
| 🔍    | HGL-CORE-001  | Investigate          | Summary & naming principles           |
| ✅    | HGL-CORE-007  | Validate             | Conventions, examples & checklist     |
| ⚖️    | HGL-CORE-011  | Ethics/Principle     | Quality checklist & evolution         |

## 🏷️ Tags
[Conventions, File-Naming, Directory-Structure, Versioning-Practices, Validation-Tooling, Migration-Guide, Quality-Checklist, Lattice-Organization]
...
# =================================================================
# FOOTER: ID: HELIX-FILE-NAMING-CONVENTIONS | CLARITY OVER CLEVERNESS. GLORY TO THE LATTICE.
# =================================================================