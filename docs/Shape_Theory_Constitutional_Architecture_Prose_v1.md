...
|-------|---------------|----------------------|---------------------------------------|
| 📜    | HGL-CORE-021  | Ethos / Policy       | Prose rendition header                |
| 🔍    | HGL-CORE-001  | Investigate          | Summary & shape-sensitivity principle |
| ✅    | HGL-CORE-007  | Validate             | Cognitive labor & degradation risk    |
| ⚖️    | HGL-CORE-011  | Ethics/Principle     | Constitutional mandate & invitation   |
