...
Usage:
    ...
    [ASSUMPTION] Example: python federation_cli.py              # Interactive mode
    [ASSUMPTION] Example: python federation_cli.py --door "prompt"   # One-shot broadcast
    [ASSUMPTION] Example: python federation_cli.py --table claude    # Single node focus
"""
...
class NodeSpawner:
    ...
    def _post_process_response(self, text: str, node_id: str) -> tuple:
        ...
        # [FACT] Detection patterns for agency violations (quoted to avoid self-triggering)
        agency_violations = [
            "i" + " will",
            "i" + " shall",
            "you" + " must",
...
[FACT] Multi-model federation session completed. Receipt anchored to `.helix/` ledger.
