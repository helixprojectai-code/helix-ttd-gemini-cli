...
class LatticePosition:
    ...
    def covers(self, other: LatticePosition) -> bool:
        ...
        return (
            ...
            and all(s >= o for s, o in zip(self.coordinate, other.coordinate))
        )
...
class DriftDetector:
    ...
    def check_epistemic_labeling(
        self, claim: str, label: EpistemicCategory, grounding: Optional[str] = None
    ) -> bool:
        """
