...
<head>
    ...
    <title>Constitutional Guardian - LIVE v1.4.6</title>
...
<body>
    <div class="container">
        <header class="panel pulse-green" style="border:none; margin-bottom:20px;">
            ...
            <h1>CONSTITUTIONAL GUARDIAN <span style="font-size: 0.8rem; vertical-align: middle; color: var(--text-dim);">LIVE v1.4.6</span></h1>
            <div class="metrics">
